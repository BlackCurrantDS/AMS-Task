...
def get_creds():
    """It connects to GMAIL API using credentials file. 
    Below method is not really recommended for security purpose to authorize API requests. 
    There is way better methods to handle it available here- https://developers.google.com/gmail/api/auth/web-server.
    I re used sample code from google for this task as email is a test email.
...
def GetMimeMessage(service, user_id, msg_id):
    ...
    It's a legacy library but it serves the purpose for this task. 
...
if __name__ == '__main__':
    ...
    matching_message = ListMessagesMatchingQuery(creds,'test.ams102019@gmail.com', query='ams')
    content = GetEmailListWithContent(matching_message,creds, 'test.ams102019@gmail.com')
